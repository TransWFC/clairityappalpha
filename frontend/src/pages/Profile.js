...
const Profile = () => {
    ...
    useEffect(() => {
        const fetchUser = async () => {
            try {
                const response = await fetch('${process.env.REACT_APP_BACKEND_API_URL}/api/auth/me', {
    ...
    const handleSendVerificationCode = async () => {
        try {
            const response = await fetch('${process.env.REACT_APP_BACKEND_API_URL}/api/auth/send-verification-code-user', {
                method: 'POST',
                headers: {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const response = await fetch('${process.env.REACT_APP_BACKEND_API_URL}/api/auth/update', {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    Authorization: `Bearer ${localStorage.getItem('token')}`,
